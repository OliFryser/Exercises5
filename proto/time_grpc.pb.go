...
type TimeServiceClient interface {
	GetServerTime(ctx context.Context, in *TimeRequest, opts ...grpc.CallOption) (*TimeResponse, error)
}
...
func (c *timeServiceClient) GetServerTime(ctx context.Context, in *TimeRequest, opts ...grpc.CallOption) (*TimeResponse, error) {
	out := new(TimeResponse)
	err := c.cc.Invoke(ctx, "/proto.TimeService/GetServerTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TimeServiceServer interface {
	GetServerTime(context.Context, *TimeRequest) (*TimeResponse, error)
...
func (UnimplementedTimeServiceServer) GetServerTime(context.Context, *TimeRequest) (*TimeResponse, error) {
...
func _TimeService_GetServerTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.TimeService/GetServerTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeServiceServer).GetServerTime(ctx, req.(*TimeRequest))
	}
